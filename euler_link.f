...
c
      ...
      real*8 xt,yt,zt,xb,yb,zb,xn,yn,zn,xn0,yn0,zn0
      ...
      do m2=0,ns2-1
        do m1=0,ns1-1
          ...
          do n=1,3
            f1(n+12)=ujc1(m1,m2,n,m)
            f2(n+12)=ujc1(m1+1,m2,n,m)
            f3(n+12)=ujc1(m1+1,m2+1,n,m)
            f4(n+12)=ujc1(m1,m2+1,n,m)

            f1(n+15)=vjc1(m1,m2,n,m)
            f2(n+15)=vjc1(m1+1,m2,n,m)
            f3(n+15)=vjc1(m1+1,m2+1,n,m)
            f4(n+15)=vjc1(m1,m2+1,n,m)

            f1(n+18)=wjc1(m1,m2,n,m)
            f2(n+18)=wjc1(m1+1,m2,n,m)
            f3(n+18)=wjc1(m1+1,m2+1,n,m)
            f4(n+18)=wjc1(m1,m2+1,n,m)
          ...
          do n=1,6
            f1(n+24)=ujc2(m1,m2,n,m)
            f2(n+24)=ujc2(m1+1,m2,n,m)
            f3(n+24)=ujc2(m1+1,m2+1,n,m)
            f4(n+24)=ujc2(m1,m2+1,n,m)

            f1(n+30)=vjc2(m1,m2,n,m)
            f2(n+30)=vjc2(m1+1,m2,n,m)
            f3(n+30)=vjc2(m1+1,m2+1,n,m)
            f4(n+30)=vjc2(m1,m2+1,n,m)

            f1(n+36)=wjc2(m1,m2,n,m)
            f2(n+36)=wjc2(m1+1,m2,n,m)
            f3(n+36)=wjc2(m1+1,m2+1,n,m)
            f4(n+36)=wjc2(m1,m2+1,n,m)
